# -*- coding: utf-8 -*-
#
# orion.algo.dehb documentation build configuration file.
#
...
import orion.algo.dehb as algo_plugin
...
man_pages = [(master_doc, "projectname", "Oríon algo dehb Documentation", [author], 1)]
