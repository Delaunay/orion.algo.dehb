...
class DEHB(BaseAlgorithm):
    ...
    def __init__(self, space, seed=None):
        super(DEHB, self).__init__(space, seed=seed)
    ...
    def set_state(self, state_dict):
        ...
        """
        # TODO: Adapt this to your algo
        super(DEHB, self).set_state(state_dict)
        self.seed_rng(0)
    ...
    def observe(self, trials):
        ...
        super(DEHB, self).observe(trials)

    @property
    def is_done(self):
        """Return True, if an algorithm holds that there can be no further improvement."""
        # NOTE: Drop if base implementation is fine.
        return super(DEHB, self).is_done
